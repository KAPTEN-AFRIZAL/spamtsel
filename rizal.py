# Jangan Lupa Subscribe KAPTEN AFRIZAL 404 :)
...
def mr_x():
    time.sleep(1)
    os.system("clear")
    print (" JANGAN LUPA SUBSCRIBE CHANNEL KAPTEN AFRIZAL 404 GESS-!!!")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/c/KAPTENAFRIZAL404")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("   ╚═╝┴  ┴ ┴┴ ┴     ╚═╝└─┘└┴┘")
    print ("")
    print ("    > Author  : KAPTEN AFRIZAL ")
    print ("    > YouTube : KAPTEN AFRIZAL 404 ")
    print ("    > Github  : github.com/KAPTEN-AFRIZAL ")
    print ("")
